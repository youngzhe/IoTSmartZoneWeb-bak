...
function Dashboard(props) {
  ...
  const gotoSmallScreen = () => {
    history.push('/smartPass/dashboard/vehicleSmall')
  }
  ...
  return (
    <div className={style.dashboard}>
      ...
      <Radio.Group defaultValue='2' className={style.btns} buttonStyle='solid'>
        <Radio.Button value='1' onClick={() => history.push('/smartPass/dashboard/staffFullScreen')}>
          人员数据
        </Radio.Button>
        <Radio.Button value='2'>车辆数据</Radio.Button>
      </Radio.Group>
